...
public class ItemsAPI extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = itemObj.updateItem(Integer.parseInt(paras.get("hidItemIDSave").toString()),
				paras.get("itemCode").toString(), paras.get("itemName").toString(), paras.get("itemPrice").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		Map paras = getParasMap(request);
		String output = itemObj.deleteItem(Integer.parseInt(paras.get("itemID").toString()));
		response.getWriter().write(output);
	}
